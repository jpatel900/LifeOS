...
| 7 | Untracked `supabase/migrations/20260612231853_remote_schema.sql` (remote drift dump) breaks local `supabase db reset` (storage trigger ordering); not committed, so CI unaffected | high | 2026-06-12 | pending — human decision: delete it, or repair ordering before committing |
