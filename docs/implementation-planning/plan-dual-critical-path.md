> **STATUS: SUPERSEDED (2026-07-26) — historical.** The two-front operating contract was replaced by the Final UX Loop: `docs/program/final-ux-loop.md` governs the board. The hand-maintained work-map file this doc points at was also retired (the map is generated by `node scripts/agent/status.mjs --html`).
