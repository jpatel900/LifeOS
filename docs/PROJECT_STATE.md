...
3. Extend persisted cockpit parity deliberately after stabilization: manual proposal creation/edit/reject, unplanning, carry-forward review actions, and retry queues still use the local/session path unless a scoped persistence slice is opened.
