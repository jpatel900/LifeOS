...
Durable judgment that spans stages. A boundary contract in any stage below must satisfy these too.
...
2. **Interruption is earned like autonomy** (FR-032). Attention is a budgeted account; every proactive surface declares an initiative rung; nothing exceeds I1 before Stage 3; graduation and automatic demotion mirror the trust ladder. Hermes presence, notifications, and delight all inherit this — none may out-speak the trust the dyad has earned.
